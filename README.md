# valuation-projects
This repository contains self-initiated valuation models built to apply and extend technical skills across equity and debt instruments. Each project is grounded in primary source data, including SEC filings, FRED, Pitchbook, and company disclosures, and follows frameworks consistent with ASC 820 fair value standards. The models are fully auditable, with sourced inputs, documented assumptions, and outputs traceable to publicly available data.
